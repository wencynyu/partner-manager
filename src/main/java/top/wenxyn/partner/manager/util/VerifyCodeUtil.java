...
public final class VerifyCodeUtil {
    ...
    private BufferedImage image;        //用来保存验证码的图片内容
    private Random r = new Random();    //获取随机数对象

    private String[] fontNames = {"宋体", "华文楷体", "黑体", "微软雅黑", "楷体_GB2312"}; //字体数组
    private String codes = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNPQRSTUVWXYZ"; //验证码数组
    ...
    public static void printImage(BufferedImage image, OutputStream outputStream) throws IOException {
